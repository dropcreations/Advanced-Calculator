...
namespace Calculator
{
    public partial class CalculatorUI : Form
    {
        ...
        private void ButtonOne_Click(object sender, EventArgs e)
        {
            if (MainDisplay.Text.Length != 10)
            {
                if (MainDisplay.Text == result[0].ToString())
                {
                    MainDisplay.Clear();
                    FormulaDisplay.Clear();
                    Array.Clear(operand, 0, 2);
                    calledOperator = ' ';
                    result[0] = 10000000000;
                }
        ...
        private void ButtonSquareRoot_Click(object sender, EventArgs e)
        {
            ...
            {
                operand[0] = double.Parse(MainDisplay.Text);
                result[0] = Math.Sqrt(operand[0]);
                MainDisplay.Text = result[0].ToString();
                FormulaDisplay.Text = $"√({operand[0]})";
            }
        }
